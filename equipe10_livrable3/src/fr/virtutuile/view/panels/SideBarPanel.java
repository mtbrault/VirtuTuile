...
public class SideBarPanel extends JPanel implements SurfacesControllerObserver {
    ...
    private void buildUp() {
        ...
        JScrollPane scrollPaneMaterialPanel = new JScrollPane(materialsPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
        add(scrollPaneMaterialPanel, materialsPanel);

        surfacesPanel.setLayout(new GridLayout(0, 1, 0, 0));
        JScrollPane scrollPane = new JScrollPane(surfacesPanel, ScrollPaneConstants.VERTICAL_SCROLLBAR_AS_NEEDED, ScrollPaneConstants.HORIZONTAL_SCROLLBAR_NEVER);
