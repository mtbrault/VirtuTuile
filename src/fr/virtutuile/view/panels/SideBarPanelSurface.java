...
public class SideBarPanelSurface extends JPanel implements ColorChangedListener {
	...
	public SideBarPanelSurface(Surface surface, int nbSurface, VirtuTuileController controller) {
		...
		textEpaisseurJoin.setForeground(Color.BLACK);
		textEpaisseurJoin.setBackground(Color.WHITE);
		this.buildUp();
	}
	...
	public void buildUp() {
		...
		if (surface.getMasked() == true) {
			...
			comboMaterial.setForeground(Color.BLACK);
			...
			comboMotif.setForeground(Color.BLACK);
			comboMotif.setBackground(Color.WHITE);
			...
			btnSurface.setForeground(Color.BLACK);
			btnSurface.setBackground(Color.WHITE);
			...
			comboAlign.setForeground(Color.BLACK);
			comboAlign.setBackground(Color.WHITE);
			...
			comboPaste.setForeground(Color.BLACK);
			comboPaste.setBackground(Color.WHITE);
			...
			comboCenter.setForeground(Color.BLACK);
			comboCenter.setBackground(Color.WHITE);
			...
			textfieldTileShift.setForeground(Color.BLACK);
			textfieldTileShift.setBackground(Color.WHITE);
